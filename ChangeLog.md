...
[0.0.0.2026092301] - 2026-09-23
-------------------------------

### Added

* Library: Lockable semaphore: The first implementation.

[0.0.0.2026092201] - 2026-09-22
-------------------------------
...
* Library: Software timer: Allow to be used as a base class.

[0.0.0.2026022701] - 2026-02-27
-------------------------------
...
* Library: Event loop toolbox: Use std::any instead of `void *`.

[0.0.0.2026022001] - 2026-02-20
-------------------------------
...
* Library: Circular buffer: Specify ordering requirements for atomic variables.
...
* Library: Circular buffer: Use concepts instead of SFINAE.
...
* Library: Byte order: The second implementation.

[0.0.0.2025082401] - 2025-08-24
-------------------------------
...
* Build: Update C++ language standard from C++17 to C++20.
...
* Library: Time measuring: last_value: The first implementation.
...
* Library: Time measuring: The first implementation.

[0.0.0.2024110901] - 2024-11-09
-------------------------------

### Changed

* Library: Mockable / Mockout: The second implementation.
